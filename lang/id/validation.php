...
return [
    ...
    | kelas validator. Beberapa aturan di bawah ini memiliki beberapa versi
    | seperti aturan 'size'. Silakan sesuaikan pesan-pesan ini.
    |
    */
    ...
    | untuk menentukan baris bahasa kustom yang spesifik untuk aturan atribut yang diberikan.
    |
    */
